...
class Map {
    ...
    generatePlayerBlocks(playerBlocks) {
        const maxBlocks = 2;
        let blockCounter = 0;
        const minDistance = 3;
    ...
    handleBlockMovementEffects(toBlock) {
    ...
    isNearOtherBoosters(x, y, minDistance) {
    ...
    isNearOtherTnts(x, y, minDistance) {
        for (let i = 0; i < this.rows; i++) {
            for (let j = 0; j < this.cols; j++) {
    ...
    isNearOtherObstacles(x, y, minDistance) {
        for (let i = 0; i < this.rows; i++) {
            for (let j = 0; j < this.cols; j++) {
    ...
    isNearOtherPlayerBlocks(x, y, minDistance) {
